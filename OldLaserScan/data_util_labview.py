...
def plot_labview_data_norun():
        labview_unsync_base_path = "/home/daq/e/LabviewDAQData/"
        labview_file_list = sorted([float(x.split("lab_meas_unsync_")[-1].split(".txt")[0]) for x in glob.glob(labview_unsync_base_path + "/lab_meas_unsync_*")])        
        all_labview_array = np.array([])
        ...
        plt.subplot(1, 3, 1)
        plt.plot((all_labview_array[:,0] - 612787664), all_labview_array[:,2]*-1000000, '.') #0 time, 1 sm1v, 2 sm1i, 3 sm2v, 4 sm2i....and 8 before so on
        #plt.axis([0, 12, 0, -50])
        ...
        plt.subplot(1, 3, 2)
        plt.plot((all_labview_array[:,0] - 612787664), all_labview_array[:,1]*-1, '.') #0 time, 1 sm1v, 2 sm1i, 3 sm2v, 4 sm2i....and 7 before so on
        #plt.axis([0, 12, 0, -400])
...
def plot_labview_data_norun1():
        ...
        plt.subplot(1, 3, 1)
        plt.plot((all_labview_array[:,0] - 612528393.880)/3600, all_labview_array[:,2]*-1000000, '.') #0 time, 1 sm1v, 2 sm1i, 3 sm2v, 4 sm2i....and 8 before so on
        #plt.axis([0, 12, 0, -50])
        plt.ylabel(u"Current (\u03bcA)")
        plt.xlabel('Time (hours)')
        plt.grid(True)
        ...
        plt.subplot(1, 3, 2)
        plt.plot((all_labview_array[:,0] - 612528393.880)/3600, all_labview_array[:,1]*-1, '.') #0 time, 1 sm1v, 2 sm1i, 3 sm2v, 4 sm2i....and 7 before so on
        #plt.axis([0, 12, 0, -400])
        plt.ylabel(u"Voltage (V)")
        plt.xlabel('Time (hours)')
        plt.grid(True)
